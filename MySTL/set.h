...
namespace mystl
{
	...
	private:
		typedef rb_tree<key_type, key_comp> base_type;
		base_type tree_;

	public:
		// 使用 rb_tree 定义的型别
		typedef typename base_type::node_type              node_type;
		typedef typename base_type::ptr				       pointer;
		typedef typename base_type::const_ptr			   const_pointer;
		typedef typename base_type::ref					   reference;
		typedef typename base_type::const_ref			   const_reference;
		...
		set(InputIter first, InputIter last) :tree_()
		{
		...
		value_type get_value_type() const { return tree_.key_comp(); }
		allocator_type get_allocator_type() const { return tree_.get_allocator(); }
		...
		size_type count(const key_type& key) { return tree_.count_unique(key); }
